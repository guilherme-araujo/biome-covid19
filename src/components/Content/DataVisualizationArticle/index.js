...
import { Button, Breadcrumb, Carousel, Badge } from 'react-bootstrap';
    ...
    return (
        ...
        <div className="article" >
            ...
            <div>
                ...
                <Carousel controls={false}>
                    ...
                    <Carousel.Item>
                        <div className="p-4 text-dark bg-light">
                            <p><strong>ATUALIZAÇÃO - dia 18/06/2020</strong></p>
                            <p><i>A partir desta data as atualizações serão automáticas e diárias.</i></p>
                        </div>
                ...
                <div className="d-flex current-date-div pt-2">
                    <p className="p-2">Data dos gráficos em exibição: </p>
                    <h5 className="pb-2"><Badge variant="warning" >{ activeDate.substr(3,2)+'/'+activeDate.substr(0,2) } </Badge></h5>
                </div>
                <p className="pt-2">O impacto social da pandemia do COVID-19 é sem precedentes na história recente da humanidade. Tal impacto é direto no sentido que o nosso dia a dia foi alterado de forma dramática, mas também indireto já que os efeitos se prolongarão por meses ou anos devido à crise econômica que certamente afetará o mundo todo. Nesse momento, a forma como as autoridades comunicam-se com a população é crucial para um eficaz engajamento do público. Isso é ainda mais crítico em relação a como os dados epidemiológicos são mostrados. </p>
