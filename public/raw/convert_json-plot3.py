...
covid_norm2 = pd.read_csv('covid-normalizado-2020-06-01.csv', decimal=',')
...
print(dataf)
pd.DataFrame.from_dict(result).to_json(r'covid_norm-plot3-06-01.json', indent=4, orient="records")