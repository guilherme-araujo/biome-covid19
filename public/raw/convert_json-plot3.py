...
covid_norm2 = pd.read_csv('covid-normalizado-2020-05-04.csv', decimal=',')
...
print(dataf)
pd.DataFrame.from_dict(result).to_json(r'covid_norm-plot3-05-04.json', indent=4, orient="records")